...
import static monty.tscf.R.id.b11;
import static monty.tscf.R.id.b32;
import static monty.tscf.R.id.b33;
import static monty.tscf.R.id.b34;
import static monty.tscf.R.id.b35;

/**
 * Created by badebaba on 9/12/2016.
 */

public class DetailTeacher extends android.support.v4.app.Fragment {
    Bundle bundle;
    // String teacherName;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.detailfragmentteacher, container, false);

        mref = new Firebase("https://tscf-b4925.firebaseio.com/teacherfeedback/");
        TeacherName = (TextView) root.findViewById(R.id.staffname);
        bundle = intent.getExtras();
        //  TeacherName.setText(bundle.getString(teachername));
        q1 = (TextView) root.findViewById(R.id.q1);
        q2 = (TextView) root.findViewById(R.id.q2);
        q3 = (TextView) root.findViewById(R.id.q3);
        q4 = (TextView) root.findViewById(R.id.q4);
        q5 = (TextView) root.findViewById(R.id.q5);
        q6 = (TextView) root.findViewById(R.id.q6);
        Elaborate = (TextView) root.findViewById(R.id.elaborate);
        ElaborateAns = (EditText) root.findViewById(R.id.elaborateans);
        submit = (Button) root.findViewById(R.id.submitbut);
        b01 = (TextView) root.findViewById(R.id.b1);
        b02 = (TextView) root.findViewById(R.id.b2);
        b03 = (TextView) root.findViewById(R.id.b3);
        b04 = (TextView) root.findViewById(R.id.b4);
        b05 = (TextView) root.findViewById(R.id.b5);
        b11 = (TextView) root.findViewById(R.id.b11);
        b12 = (TextView) root.findViewById(R.id.b12);
        b13 = (TextView) root.findViewById(R.id.b13);
        b14 = (TextView) root.findViewById(R.id.b14);
        b15 = (TextView) root.findViewById(R.id.b15);
        b21 = (TextView) root.findViewById(R.id.b21);
        b22 = (TextView) root.findViewById(R.id.b22);
        b23 = (TextView) root.findViewById(R.id.b23);
        b24 = (TextView) root.findViewById(R.id.b24);
        b25 = (TextView) root.findViewById(R.id.b25);
        b31 = (TextView) root.findViewById(R.id.b31);
        b32 = (TextView) root.findViewById(R.id.b32);
        b33 = (TextView) root.findViewById(R.id.b33);
        b34 = (TextView) root.findViewById(R.id.b34);
        b35 = (TextView) root.findViewById(R.id.b35);
        b41 = (TextView) root.findViewById(R.id.b41);
        b42 = (TextView) root.findViewById(R.id.b42);
        b43 = (TextView) root.findViewById(R.id.b43);
        b44 = (TextView) root.findViewById(R.id.b44);
        b45 = (TextView) root.findViewById(R.id.b45);
        b51 = (TextView) root.findViewById(R.id.b51);
        b52 = (TextView) root.findViewById(R.id.b52);
        b53 = (TextView) root.findViewById(R.id.b53);
        b54 = (TextView) root.findViewById(R.id.b54);
        b55 = (TextView) root.findViewById(R.id.b55);
